"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("lodash/includes"),a=require("aws-amplify"),o=require("lodash/cloneDeep"),r=require("xstate"),n=require("xstate/lib/actions"),t=require("lodash/get"),i=require("lodash/isEmpty"),l=require("lodash/merge"),s=require("lodash/pickBy"),u=require("style-dictionary/lib/utils/deepExtend"),d=require("style-dictionary/lib/utils/flattenProperties"),c=require("lodash/kebabCase"),v=require("style-dictionary/lib/utils/references/usesReference");function m(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}var g,f,p=m(e),h=m(o),b=m(t),S=m(i),w=m(l),C=m(s),y=m(u),k=m(d),A=m(c),I=m(v),E=function(e){var a;return null===(a=e.context.actorRef)||void 0===a?void 0:a.getSnapshot()},x=function(e){var a;return null===(a=E(e))||void 0===a?void 0:a.context};exports.AuthChallengeNames=void 0,(g=exports.AuthChallengeNames||(exports.AuthChallengeNames={})).SMS_MFA="SMS_MFA",g.SOFTWARE_TOKEN_MFA="SOFTWARE_TOKEN_MFA",g.NEW_PASSWORD_REQUIRED="NEW_PASSWORD_REQUIRED",g.RESET_REQUIRED="RESET_REQUIRED",g.MFA_SETUP="MFA_SETUP",exports.FederatedIdentityProviders=void 0,(f=exports.FederatedIdentityProviders||(exports.FederatedIdentityProviders={})).Apple="SignInWithApple",f.Amazon="LoginWithAmazon",f.Facebook="Facebook",f.Google="Google";
/*! *****************************************************************************
